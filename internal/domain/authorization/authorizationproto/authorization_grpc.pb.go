...
const (
	Authorization_Group_FullMethodName  = "/authorizationproto.Authorization/Group"
	Authorization_Policy_FullMethodName = "/authorizationproto.Authorization/Policy"
)
...
type AuthorizationClient interface {
	Group(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*AuthorizationResponse, error)
	Policy(ctx context.Context, in *PolicyRequest, opts ...grpc.CallOption) (*AuthorizationResponse, error)
}
...
func (c *authorizationClient) Group(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*AuthorizationResponse, error) {
...
func (c *authorizationClient) Policy(ctx context.Context, in *PolicyRequest, opts ...grpc.CallOption) (*AuthorizationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthorizationResponse)
...
type AuthorizationServer interface {
	Group(context.Context, *GroupRequest) (*AuthorizationResponse, error)
	Policy(context.Context, *PolicyRequest) (*AuthorizationResponse, error)
...
func (UnimplementedAuthorizationServer) Group(context.Context, *GroupRequest) (*AuthorizationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Group not implemented")
}
func (UnimplementedAuthorizationServer) Policy(context.Context, *PolicyRequest) (*AuthorizationResponse, error) {
...
var Authorization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authorizationproto.Authorization",
	...
	Metadata: "internal/domain/authorization/authorization.proto",
}
